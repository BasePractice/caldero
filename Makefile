...
.DEFAULT_GOAL := help
.PHONY: help build test test-race test-integration lint vet fmt fmt-check tidy-check proto up down logs migrate-status images clean save-keycloak-config
