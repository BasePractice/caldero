...
| Подстановка себе роли снаружи | закрыто | `X-Roles` не перечислен во входных заголовках ни одного маршрута: перезаписывать его нечем, пока роли не попадают в токен, и клиент прислал бы себе любую роль сам (T-093) |
